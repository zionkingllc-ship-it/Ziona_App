    ...
    <KeyboardAvoidingWrapper>
      ...
      <YStack flex={1} padding="$4" gap="$4" marginTop="$10" width="100%">
        ...
        <YStack alignItems="center" marginTop="$6" gap="$3">
          <Text  fontFamily={"$body"} fontSize="$4" fontWeight="600" color={"#754800"}>
            Create new password
          </Text>
        </YStack>
        ...
        <YStack gap="$2" marginLeft={5}>
          <Text  fontFamily={"$body"} fontSize={"$4"} fontWeight={"500"} color={colors.headerText}>Your password must have at least:</Text>
